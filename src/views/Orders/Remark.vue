    ...
    <div class="remark">
        ...
        <div class="view-body">
            <section>
                ...
                <!-- 单选 -->
                <div class="switch">
                    <span @click="radioItemClick(item)" :class="{'selected':item.select}" v-for="(item,index) in radioItem" :key="index" class="switch-item item-line">{{item.name}}</span>
                </div>
                <!-- 多选 -->
                <div class="switch" v-for="(item,index) in switchItem" :key="index">
                    <span class="switch-item" :class="{'selected':item.select}" @click="item.select=!item.select">{{item.name}}</span>
                </div>
            </section>
